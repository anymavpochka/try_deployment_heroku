...
session.add_all([
   db_classes.Categories(id = data_categories['categories'][0]['id'], category_name = data_categories['categories'][0]['name']),
   db_classes.Categories(id = data_categories['categories'][1]['id'], category_name = data_categories['categories'][1]['name']),
   db_classes.Categories(id = data_categories['categories'][2]['id'], category_name = data_categories['categories'][2]['name']),
   db_classes.Categories(id = data_categories['categories'][3]['id'], category_name = data_categories['categories'][3]['name'])]
)
session.commit()
